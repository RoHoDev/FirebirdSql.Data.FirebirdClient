...
namespace FirebirdSql.Data.FirebirdClient
{
	public sealed class FbDatabaseInfo
	{
		...
		public string GetIscVersion() => GetIscVersionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetServerVersion() => GetServerVersionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetServerClass() => GetServerClassImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetPageSize() => GetPageSizeImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetAllocationPages() => GetAllocationPagesImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetBaseLevel() => GetBaseLevelImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetDbId() => GetDbIdImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetImplementation() => GetImplementationImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public bool GetNoReserve() => GetNoReserveImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetOdsVersion() => GetOdsVersionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetOdsMinorVersion() => GetOdsMinorVersionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetMaxMemory() => GetMaxMemoryImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetCurrentMemory() => GetCurrentMemoryImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public bool GetForcedWrites() => GetForcedWritesImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetNumBuffers() => GetNumBuffersImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetSweepInterval() => GetSweepIntervalImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public bool GetReadOnly() => GetReadOnlyImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetFetches() => GetFetchesImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetMarks() => GetMarksImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetReads() => GetReadsImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetWrites() => GetWritesImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetBackoutCount() => GetBackoutCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetDeleteCount() => GetDeleteCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetExpungeCount() => GetExpungeCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetInsertCount() => GetInsertCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetPurgeCount() => GetPurgeCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public long GetReadIdxCount() => GetReadIdxCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public long GetReadSeqCount() => GetReadSeqCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public long GetUpdateCount() => GetUpdateCountImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetDatabaseSizeInPages() => GetDatabaseSizeInPagesImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public long GetOldestTransaction() => GetOldestTransactionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public long GetOldestActiveTransaction() => GetOldestActiveTransactionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public long GetOldestActiveSnapshot() => GetOldestActiveSnapshotImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public long GetNextTransaction() => GetNextTransactionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public int GetActiveTransactions() => GetActiveTransactionsImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public List<string> GetActiveUsers() => GetActiveUsersImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
