...
namespace FirebirdSql.Data.Services
{
	public sealed class FbServerProperties : FbService
	{
		...
		public int GetVersion() => GetVersionImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetRootDirectory() => GetRootDirectoryImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetLockManager() => GetLockManagerImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetMessageFile() => GetMessageFileImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public FbDatabasesInfo GetDatabasesInfo() => GetDatabasesInfoImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public FbServerConfig GetServerConfig() => GetServerConfigImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
