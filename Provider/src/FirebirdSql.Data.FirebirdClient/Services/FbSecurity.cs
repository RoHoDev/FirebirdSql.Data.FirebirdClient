...
namespace FirebirdSql.Data.Services
{
	public sealed class FbSecurity : FbService
	{
		...
		public void AddUser(FbUserData user) => AddUserImpl(user, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void DeleteUser(FbUserData user) => DeleteUserImpl(user, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void ModifyUser(FbUserData user) => ModifyUserImpl(user, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public FbUserData DisplayUser(string userName) => DisplayUserImpl(userName, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public FbUserData[] DisplayUsers() => DisplayUsersImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public string GetUsersDbPath() => GetUsersDbPathImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
