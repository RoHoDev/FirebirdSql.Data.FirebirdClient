...
namespace FirebirdSql.Data.Services
{
	public sealed class FbConfiguration : FbService
	{
		...
		public void SetSqlDialect(int sqlDialect) => SetSqlDialectImpl(sqlDialect, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void SetSweepInterval(int sweepInterval) => SetSweepIntervalImpl(sweepInterval, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void SetPageBuffers(int pageBuffers) => SetPageBuffersImpl(pageBuffers, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void DatabaseShutdown(FbShutdownMode mode, int seconds) => DatabaseShutdownImpl(mode, seconds, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void DatabaseShutdown2(FbShutdownOnlineMode mode, FbShutdownType type, int seconds) => DatabaseShutdown2Impl(mode, type, seconds, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void DatabaseOnline() => DatabaseOnlineImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void DatabaseOnline2(FbShutdownOnlineMode mode) => DatabaseOnline2Impl(mode, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void ActivateShadows() => ActivateShadowsImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void SetForcedWrites(bool forcedWrites) => SetForcedWritesImpl(forcedWrites, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void SetReserveSpace(bool reserveSpace) => SetReserveSpaceImpl(reserveSpace, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void SetAccessMode(bool readOnly) => SetAccessModeImpl(readOnly, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void NoLinger() => NoLingerImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
