...
namespace FirebirdSql.Data.Services
{
	public sealed class FbTrace : FbService
	{
		...
		public void Start(string sessionName) => StartImpl(sessionName, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void Stop(int sessionID) => StopImpl(sessionID, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void Suspend(int sessionID) => SuspendImpl(sessionID, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void Resume(int sessionID) => ResumeImpl(sessionID, new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
		...
		public void List() => ListImpl(new AsyncWrappingCommonArgs(false, CancellationToken.None)).GetAwaiter().GetResult();
